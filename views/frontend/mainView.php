		...
		<div class="row">
			<div class="col-md-12">
				...
				<?php foreach ($hotproduct as $rows): ?>
					<div class="item">
	    				<div class="product">
	    					<a href="<?php echo $rows->name; ?>-<?php echo $rows->product_id; ?>.html" class="img-prod"><img class="img-fluid" src="assets/upload/product/<?php echo $rows->img; ?>" alt="<?php echo $rows->name; ?>">
	    					</a>
	    					<div class="text pt-3 px-3">
	    						<h3><a href="<?php echo $rows->name; ?>-<?php echo $rows->product_id; ?>.html"><?php echo $rows->name; ?></a></h3>
	    						<div class="d-flex">
	    							<div class="pricing">
		    							<p class="price"><span><?php echo number_format($rows->price); ?></span>
		    						</div>
		    						<div class="rating">
		    							<p class="text-right">
			...
			<div class="col-sm col-md-6 col-lg ftco-animate">
				<div class="product">
					...
					<div class="text py-3 px-3">
						<h3><a href="<?php echo $rows->name; ?>-<?php echo $rows->product_id; ?>.html">Young <?php echo $rows->name; ?></a></h3>
						<div class="d-flex">
							<div class="pricing">
